...
namespace tinyxml2
{
	...
	*/
	...
	bool XMLUtil::ToBool(const char* str, bool* value)
	{
		...
		static const char* true_str[] = { "true", "True", "TRUE", 0 };
		static const char* false_str[] = { "false", "False", "FALSE", 0 };

		for (int i = 0; true_str[i]; ++i) {
			if (StringEqual(str, true_str[i])) {
				*value = true;
				return true;
			}
		}
		for (int i = 0; false_str[i]; ++i) {
			if (StringEqual(str, false_str[i])) {
				*value = false;
				return true;
			}
		}
