...
%1/14/2016
dbstop if error;
basedir='Z:\Mikhail\ReflectionQDIC\part40_fml_redo_neurons_with_two_species_of_beads\start_imaging\dried_up_redo\redo_calibration\';
name = @(t,x) sprintf('%s\\f0_t0_i%d_ch0_c0_r0_z0_m%d.tif',basedir,t,x-1);
%start=1;stop=511;(
t=0;
%start=1;stop=250;
start=1;stop=512;
...
[~,lct] = findpeaks(amp,'MinPeakProminence',10);
%lct=lct(end);
%[~,lct]=max(amp);
